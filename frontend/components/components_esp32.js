        ...
        <div class="fixed left-0 top-0 h-screen w-64 bg-white border-r border-gray-200 flex flex-col justify-between">
            ...
            <div>
                ...
                <nav class="flex flex-col gap-1 mt-4 px-2">
                    ...
                    <a href="../informacion/informacion.html" class="flex items-center gap-3 p-2 rounded text-gray-700 hover:bg-gray-100 transition">
                    ...
                    <a href="../control/control.html" class="flex items-center gap-3 p-2 rounded text-gray-700 hover:bg-gray-100 transition">
